console.log(`Write a range function that takes two arguments, 
...
Run the example program and see whether it does indeed 
return 55.

As a bonus assignment, modify your range function to 
take an optional third argument that indicates 
...
The function call range(1, 10, 2) should 
